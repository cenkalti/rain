...
import (
	...
	"github.com/cenkalti/rain/internal/torrent/internal/peerconn"
...
func (t *Torrent) sendFirstMessage(p *peer.Peer) {
	...
	extHandshakeMsg := peerprotocol.NewExtensionHandshake(metadataSize, t.config.ExtensionHandshakeClientVersion)
